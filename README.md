...
```
git clone https://github.com/cockpit-project/Pi-Monitor.git
cd Pi-Monitor
make
```
...
ln -s `pwd`/dist ~/.local/share/cockpit/Pi-Monitor
```
...
remove manually the symlink:
    ...
    rm ~/.local/share/cockpit/Pi-Monitor
...
your project after forking from Pi-Monitor.
...
which is run weekly or upon [manual request](https://github.com/cockpit-project/Pi-Monitor/actions) through the
[npm-update.yml](.github/workflows/npm-update.yml) [GitHub action](https://github.com/features/actions).

# Further reading

 * The [Starter Kit announcement](https://cockpit-project.org/blog/cockpit-Pi-Monitor.html)
